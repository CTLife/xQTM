...
my $input_g  = '';  ## such as "7-bedGraph-Bismark"
my $output_g = '';  ## such as "8-Me-BigWig-Bismark"
...
my $HELP = '
        ...
        Usage:
               perl  BS-Seq_8.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  BS-Seq_8.pl   -genome hg38   -in 7-bedGraph-Bismark   -out 8-Me-BigWig-Bismark    > BS-Seq_8.runLog
...
$input_g  = '7-bedGraph-Bismark';    ## This is only an initialization value or suggesting value, not default value.
$output_g = '8-Me-BigWig-Bismark';   ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  BS-Seq_8.pl  -help' \n";
    exit 0;
}
