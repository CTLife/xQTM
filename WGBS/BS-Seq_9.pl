...
my $input_g  = '';  ## such as "8_bedGraph-Bismark"
my $output_g = '';  ## such as "9_Me-BigWig-Bismark"
...
my $HELP = '
        ...
        Step 9: This script generates a cytosine methylation report for a genome of interest.
        ...
        Usage:
               perl  BS-Seq_9.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  BS-Seq_9.pl   -genome hg38   -in 8_bedGraph-Bismark   -out 9_Me-BigWig-Bismark    > BS-Seq_9.runLog
...
## Version Infromation
my $version = "    The 9th Step of BSDA (BS-Seq Data Analyzer), version 0.9.9, 2023-09-20.";
...
$input_g  = '8_bedGraph-Bismark';    ## This is only an initialization value or suggesting value, not default value.
$output_g = '9_Me-BigWig-Bismark';   ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  BS-Seq_9.pl  -help' \n";
    exit 0;
}
