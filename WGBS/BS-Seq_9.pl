...
my $output_g = '';  ## such as "9-coveredSites-Bismark"
...
my $HELP = '
        ...
        For instance:
               perl  BS-Seq_9.pl   -genome hg38   -in 7-callMethylation   -out 9-coveredSites-Bismark    > BS-Seq_9.runLog
...
$output_g = '9-coveredSites-Bismark';   ## This is only an initialization value or suggesting value, not default value.
...
for (my $i=0; $i<=$#BAMfiles_g; $i++) {
    ...
    system("Rscript   BS-Seq_9.R   $dir1   $temp.CHG.bismark.cov    $dir1a/$temp   ");         
    system("Rscript   BS-Seq_9.R   $dir2   $temp.CHH.bismark.cov    $dir2a/$temp   ");         
    system("Rscript   BS-Seq_9.R   $dir3   $temp.CpG.bismark.cov    $dir3a/$temp   ");  
