...
my $HELP = '
        ------------------------------------------------------------------------------------------------------------------------------------------------------
        ------------------------------------------------------------------------------------------------------------------------------------------------------
        Step 3: Remove PCR and optical duplicates by using clumpify.sh of BBMap. (Optional)
        ...
        Usage:
               perl BS-Seq_3.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]
        For instance:
               nohup  time   perl BS-Seq_3.pl   -in 2_removedAdapters   -out 3_removedDups    > BS-Seq_3.runLog.txt  2>&1     &      
...
## Version Infromation
my $version = "    The 3rd Step,  version 0.9.9, 2023-09-20. (Optional) ";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl BS-Seq_3.pl  -help' \n";
    exit 0;
}
