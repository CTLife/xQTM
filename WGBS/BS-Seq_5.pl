...
my $input_g    = '';  ## such as "4_rawBAM"
my $output_g   = '';  ## such as "5_finalBAM"
...
my $HELP = '
        ------------------------------------------------------------------------------------------------------------------------------------------------------
        ------------------------------------------------------------------------------------------------------------------------------------------------------
        Step 5: Only the mapped reads with MAPQ>20 are retained and reads on other chromosomes, all of them are removed. 
        ...
        Usage:
               perl BS-Seq_5.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]   
        For instance:
               nohup  time  perl BS-Seq_5.pl   -genome hg38   -in 4_rawBAM   -out 5_finalBAM       > BS-Seq_5.PE.runLog 2>&1  &    
...
## Version Infromation
my $version = "    The 5th Step, version 0.9.9, 2023-09-20.";
...
$input_g  = '4_rawBAM';           ## This is only an initialization value or suggesting value, not default value.
$output_g = '5_finalBAM';         ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  BS-Seq_5.pl  -help' \n";
    exit 0;
}
