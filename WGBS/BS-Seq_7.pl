...
my $input_g  = '';  ## such as "6_BAMPE"
my $output_g = '';  ## such as "7_callMethylation"
...
my $HELP = '
        ...
        Step 7: Extracts the methylation call for every single C analysed by using bismark_methylation_extractor.
        ...
        Usage:
               perl  BS-Seq_7.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  BS-Seq_7.pl   -genome hg38   -in 6_BAMPE   -out 7_callMethylation    > BS-Seq_7.runLog
...
## Version Infromation
my $version = "    The 7th Step , version 0.9.9, 2023-09-20.";
...
$input_g  = '6_BAMPE';           ## This is only an initialization value or suggesting value, not default value.
$output_g = '7_callMethylation';   ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  BS-Seq_7.pl  -help' \n";
    exit 0;
}
