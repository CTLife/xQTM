...
my $input_g  = '';  ## such as "8_callMethylation"
my $output_g = '';  ## such as "10_coveredSites-Bismark"
...
my $HELP = '
        ...
        Step 10: This script generates some figures for the correlation of number of covered C sites and reads.
        ...
        Usage:
               perl  BS-Seq_10.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]
        For instance:
               perl  BS-Seq_10.pl   -genome hg38   -in 8_callMethylation   -out 10_coveredSites-Bismark    > BS-Seq_10.runLog
...
## Version Infromation
my $version = "    The 10th Step of BSDA (BS-Seq Data Analyzer), version 0.9.9, 2023-09-20.";
...
$input_g  = '8_callMethylation';         ## This is only an initialization value or suggesting value, not default value.
$output_g = '10_coveredSites-Bismark';    ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  BS-Seq_10.pl  -help' \n";
    exit 0;
}
...
for (my $i=0; $i<=$#BAMfiles_g; $i++) {
    ...
    system("Rscript   BS-Seq_10.R   $dir1   $temp.CHG.bismark.cov    $dir1a/$temp   ");         
    system("Rscript   BS-Seq_10.R   $dir2   $temp.CHH.bismark.cov    $dir2a/$temp   ");         
    system("Rscript   BS-Seq_10.R   $dir3   $temp.CpG.bismark.cov    $dir3a/$temp   ");  
