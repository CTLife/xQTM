...
my $HELP = '
        ...
        Usage:
               perl  BS-Seq_1.pl    [-version]    [-help]     [-in inputDir]   
        For instance:
               nohup   time    perl  BS-Seq_1.pl    -in 1_rawFASTQ   > BS-Seq_1.runLog.txt  2>&1    & 
...
## Version Infromation
my $version = "    The 1st Step, version 0.9.9, 2023-09-20.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  BS-Seq_1.pl  -help' \n";
    exit 0;
}
