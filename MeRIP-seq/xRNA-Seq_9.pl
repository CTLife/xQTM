...

{
    ...
    system("multiBigwigSummary bins   --bwfiles @BigWigfiles_g2    --smartLabels    --binSize 1000   --numberOfProcessors 2    --verbose    --outRawCounts $output_sub1/B.1-RawCounts.1000bp-Bin.txt   --outFileName $output_sub1/B.1-results.1000bp.npz  --chromosomesToSkip chrX chrY chrM   >> $output_sub1/B.1-runLog.txt   2>&1");                               
    ...
    &myMakeDir($output_sub1);
    system("multiBigwigSummary bins   --bwfiles @BigWigfiles_g2    --smartLabels    --binSize 500   --numberOfProcessors 2    --verbose    --outRawCounts $output_sub1/C.1-RawCounts.500bp-Bin.txt   --outFileName $output_sub1/C.1-results.500bp.npz    --chromosomesToSkip chrX chrY chrM   >> $output_sub1/C.1-runLog.txt   2>&1");                               
